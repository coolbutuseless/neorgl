...
lsystem.eval <- function(expr, turtle) {
  if (length(expr) == 3) {
    ...
    if (as.name(expr) == "stem") {
      turtle <- turtle.move(turtle, 5, "brown")
    } else if (as.name(expr) == "short") {
      turtle <- turtle.move(turtle, 5, "brown")
    ...
    else if (as.name(expr) == "roll") {
      turtle <- turtle.head(turtle, 60)
    } else if (as.name(expr) == "down") {
      turtle <- turtle.pitch(turtle, 10)
    } else if (as.name(expr) == "up") {
      turtle <- turtle.pitch(turtle, -10)
    } else if (as.name(expr) == "left") {
      turtle <- turtle.head(turtle, 1)
    } else if (as.name(expr) == "right") {
      turtle <- turtle.head(turtle, -1.5)
    } else if (as.name(expr) == "turnleft") {
      turtle <- turtle.head(turtle, 20)
    } else if (as.name(expr) == "turnright") {
      turtle <- turtle.head(turtle, -20)
